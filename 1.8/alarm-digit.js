  ...
  switch(motivo)
  {
    case "agua":
      gather.say(
        ...
        'Se ha detectado que el nivel de agua de cisterna se encuentra fuera de los rangos de normalidad. Presione uno para poner el caso en tratamiento.'
                );
      break;
    case "caldera":
      gather.say(
          {voice: "alice", language: "es-ES"},
          'Se ha detectado que la temperatura de caldera se encuentra fuera de los rangos de normalidad. Presione uno para poner el caso en tratamiento.'
                );
      break;
    case "ambiente":
      gather.say(
        {voice: "alice", language: "es-ES"},
        'Se ha detectado que la temperatura ambiente se encuentra fuera de los rangos de normalidad. Presione uno para poner el caso en tratamiento.'
                );
      break;
    case "luz":
      gather.say(
        {voice: "alice", language: "es-ES"},
        'Se ha detectado que el nivel de luminosidad se encuentra fuera de los rangos de normalidad. Presione uno para poner el caso en tratamiento.'
                );
      break;
    ...
    switch (request.body.Digits) {
      case '1': 
        ...
        twiml.hangup();
            break;
      default:
        twiml.say({voice: "alice", language: "es-ES"}, 'El valor ingresado no es una opción válida.');
        twiml.redirect('/tierradelfuego');
        break;
    }
  } else {
    // If no input was sent, redirect to the /voice route
    twiml.say({voice: "alice", language: "es-ES"}, 'No ha ingresado nada.');
    twiml.redirect('/tierradelfuego');
  }
